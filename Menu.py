...
def main_menu():
    ...
    while True:
            ...
            if bouton_2.collidepoint((mx, my)):
                if click:
                    options() # on défini le lien du bouton option
...
def resolution():
    ...
    while True:
            ...
            if bouton_1.collidepoint((mx, my)):
                if click:
                    pass # on défini l'affectation du bouton selections resolution1
            if bouton_2.collidepoint((mx, my)):
                if click:
                    import Menu_res_2
            ...
            if bouton_3.collidepoint((mx, my)):
                if click:
                    import Menu_res_3
                    Menu_res_3() # on défini l'affectation du bouton resolution3
