...
longueur = 1280 # on défini la largeur de la fenetre
largeur = 720 # on défini la largeur de la fenetre
...
son_on = pygame.image.load("textures/textures_menu/son_on.png").convert_alpha()
...
son = pygame.image.load("textures/textures_menu/son.png").convert_alpha()
...
son_on_bleu = pygame.image.load("textures/textures_menu/son_on_bleu.png").convert_alpha()
...
def main_menu():
    ...
    while True:
            ...
            if temps > 60 :
                son = pygame.mixer.music.load('sons/Texxit/2.wav') #On prend un son dans le répertoire et on l'associe à son
                pygame.mixer.music.queue('sons/Texxit/2.wav') #mettre le sons Texxit 2.wav dans la queue
            ...
            if bouton_2.collidepoint((mx, my)):
                if click:
                    options() # on defini le lien du bouton option
...
def selection_niveaux():
    ...
    while True:
            ...
            if bouton_1.collidepoint((mx, my)):
                if click:
                    import tutoriel # on défini l'affectation du bouton tutoriel
            if bouton_2.collidepoint((mx, my)):
                if click:
                    import Main# on défini l'affectation du bouton jeu
            if bouton_3.collidepoint((mx, my)):
                if click:
                    main_menu() # on défini l'affection du bouton retour
    ...
    while True:
            ...
            if bouton_2.collidepoint((mx, my)):
                if click:
                    ...
                    Menu_son() # on défini l'affectation du bouton son
            if bouton_3.collidepoint((mx, my)):
                if click:
            ...
            if bouton_2.collidepoint((mx, my)):
                screen.blit(son_on_bleu, (pos_long, pos_larg))
            else:
                screen.blit(son_on, (pos_long, pos_larg))
...
def resolution():
    ...
    while True:
            ...
            if bouton_1.collidepoint((mx, my)):
                if click:
                    import Menu
                    Menu() # on défini l'affectation du bouton resolution1
            if bouton_2.collidepoint((mx, my)):
                if click:
                    import Menu_res_2
                    Menu_res_2() # on défini l'affectation du bouton resolution2
            if bouton_3.collidepoint((mx, my)):
                if click:
                    pass # on défini l'affectation du bouton resolution3
