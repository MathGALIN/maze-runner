...
def main_menu():
    ...
    while True:
            ...
            screen.blit(titre ,((longueur/2)-244,pos_larg - 225)) # on pose le titre
            ...
            bouton_3 = pygame.Rect(pos_long , pos_larg + 110, onglet_long, onglet_larg)# on défini les coordonées des boutons
            ...
            if bouton_3.collidepoint((mx, my)):
                if click:
                    quitter() # on défini l'affection du bouton quitter
            ...
            if bouton_2.collidepoint((mx, my)):
                ...
                screen.blit(option_off, (pos_long, pos_larg))
...
def resolution():
    ...
    while True:
            ...
            if bouton_1.collidepoint((mx, my)):
                if click:
                    import Menu_son
                    Menu_son() # on défini l'affectation du bouton resoluton1
            if bouton_2.collidepoint((mx, my)):
                if click:
